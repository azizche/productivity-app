...
dir('client'){
    ...
    steps {
        script {
sh 'curl https://slack.com/api/chat.postMessage -X POST -d "channel=#projet-cicd" -d "text=Hello World" -d "token=xoxb-6307892099297-6288968197382-f2QRtfmOrneI0fuNyizk54GD" -d "icon_emoji=:simple_smile:"'
           }
    }
}
    }
